<template>
	<div class="consulting-business-wrap">
		<h2 class="consulting-business-title">培训业务</h2>
			...
			<div class="consulting-list-wrap">
				...
				<div class="consulting-list">
					<ul :style="{width: ulWidth + 'rem',left: ulLeft + 'rem'}">
						<li v-for="(item,index) in dataList" :class="{activeItem:activeIndex == index}" @click="activeIndex = index">
							<img :src="item.thumb">
...
export default {
	...
	data() {
		return {
			...
			nextActive: false,
			activeIndex: 0,
			bigScreen: document.body.clientWidth > 1024 ? true : false,
		}
	},
	created() {
