	...
	<div class="header">
		...
		<ul class="header-nav" :class="{openNav:showNav}">
			...
			<li :class="{active:name == 'insuranceZhenhua'}">
				<router-link to="/zhenhua">真话保险</router-link>
			</li>
			<li class="two-stage-nav" :class="{active:name == 'insuranceConsultation'}">
				...
				<ul v-show="showConsulting"> 
					<li>
						<router-link to="/zhenhua">在线课程</router-link>
					</li>
					<li>
						<router-link to="/consultation/consulting">咨询业务</router-link>
					</li>
					<li>
						<router-link to="/consultation/training">培训业务</router-link>
					</li>
					<li>
						<router-link to="/consultation/conference">会议业务</router-link>
					</li>
					<li>
						<router-link to="/consultation/project">资格认证</router-link>
					</li>
				</ul>
			</li>
			...
			<li class="two-stage-nav" :class="{active:name == 'aboutUs'}">
				...
				<ul class="about-us-list" v-show="showAboutUs"> 
					<li>
						<router-link to="/about/us/intro">公司介绍</router-link>
					</li>
					<!-- <li>
						<router-link to="/about/us/team">公司团队</router-link>
					</li> -->
					<li>
						<router-link to="/about/us/recruit">人才招聘</router-link>
					</li>
					<li>
						<router-link to="/about/us/contact">联系我们</router-link>
					</li>
				</ul>
			</li>
